...
function reloadExam()
{
    ...
    swal("Be Ready!","English Exam started.","success");
    drawQuset(index,i+1);
...
//*********************************************************///the two type Question*****************************************************
        ...
        function drawQuset(idx,num)
        {
            ...
            if (Q.QuestionType==1)
            {
                ...
                HTMLtxt +='<tr><td><input type="radio" name="answer" onclick="check_answer(1,'+idx+')" id="1"<span>'+Q.Answers[0]+'</span></td>'
                HTMLtxt +='<td><input type="radio" name="answer" onclick="check_answer(2,'+idx+')" id="2"<span>'+Q.Answers[1]+'</span></td></tr>'
                HTMLtxt +='<tr><td><input type="radio" name="answer" onclick="check_answer(3,'+idx+')" id="3"<span>'+Q.Answers[2]+'</span></td>'
                HTMLtxt +='<td><input type="radio" name="answer" onclick="check_answer(4,'+idx+')" id="4"<span>'+Q.Answers[3]+'</span></td></tr>'
                HTMLtxt+='</table><br/><hr/>'
...
function check_answer(x,idx)
            {
            	Q=exam.Questions[idx];
                if(x==Q.CorrectAnswer)
                {
                    swal("NICE!","Correct Answer.","success");
                    for(x=1;x<=4;x++)
                    { 
                        if(x==Q.CorrectAnswer)
                        {
                            $("td input[id='"+x+"']").parent().css({
                                borderRadius: '5px',
    ...
    function correct_answer(x,idx)
            {
               for(x=1;x<=4;x++)
                ...
                else
                {
                    ...
                    $("td input[id='"+x+"']").parent().hide('slow');
                }
                }
            }
...
/*************************************** // onload function designed and created by Ahmed salama **********************************************************/
        ...
        $(function()
        {
            var end = arr[arrLength-1];
                ...
                $("#lbtn").removeClass('btn-disable');
                $("#flag").removeClass('btn-disable');
                 $("#answer").click(function(event)  // button prev
                {
                    correct_answer(4,index);
                });
                ...
                $("#finish").click(function(event)  // button last
                {
                    ...
                    else /*if second exam finished*/
                    {
                        ...
                        (
                            ...
                            i=0;
                            maindiv = document.getElementById("divExam");
                            swal("Be Ready!","IQ Exam started.","success");
                            drawQuset(index,i+1);
                            var end = arr[arrLength-1];
                                $("#fbtn").addClass('btn-disable');
                                $("#nbtn").removeClass('btn-disable');
